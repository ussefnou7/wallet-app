...
public enum ErrorCode {
    ...
    TOKEN_EXPIRED("TOKEN_EXPIRED", "Session expired. Please login again.", HttpStatus.UNAUTHORIZED),
    ...
    ACCOUNT_INACTIVE("ACCOUNT_INACTIVE", "This account is inactive.", HttpStatus.FORBIDDEN),
